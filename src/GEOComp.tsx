...
let GEOComp = (function () {
  ...
  const childrenMap = {
    ...
    center: withDefault(ArrayControl, "[31,31]"),
    zoom: withDefault(NumberControl, 4),
...
*/
    ...
    mapStyleUrl: stringSimpleControl(
    ...
    */
    ...
    .setPropertyViewFn((children: any) => {
      return (
        <>
          <Section name="Config">
            {children.mapStyleUrl.propertyView({ label: "style gl" })}
            ...
            <span>
              Hide <b>AntV L7 logo</b> only if you are entitled
            </span>
